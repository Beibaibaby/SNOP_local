...
% Load data
load('/Users/dracoxu/Research/SNOP_local/data_matt/Pe160223.mat')
%spkmat = areaData.V4.spont(8).X';  % Note the transpose here
spkmat = areaData.V4.spont(3).X';  % Note the transpose here
...
true_statistics = table(50, rate1, var1, FanoFactor1, fano_var, mean_corr1, mean_corr_var, fa_percentshared, fa_percent_var, fa_dshared, fa_dim_var, fa_normevals, fa_normeval_var, default_weights, ...
...
output_file_name = sprintf('./data/matt_4.mat');
